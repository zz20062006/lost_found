    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="publish-lost.jsp">发布失物</a></li>
...
<div class="container" style="max-width: 700px; margin-top: 20px;">
    <div class="card">
        <div class="card-body p-4">
            <h4 class="mb-4"><i class="fas fa-edit" style="color:#dc3545;"></i> 发布失物信息</h4>
            <form id="publishLostForm" enctype="multipart/form-data">
                <div class="form-group">
                    <label>物品名称 <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="title" placeholder="例如：黑色钱包、iPhone 14..." required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>丢失时间</label>
                    <input type="datetime-local" class="form-control" name="lostTime">
                </div>
                <div class="form-group">
                    <label>丢失地点</label>
                    <input type="text" class="form-control" name="lostPlace" placeholder="例如：图书馆二楼、一食堂...">
                </div>
                <div class="form-group">
                    <label>物品描述</label>
                    <textarea class="form-control" name="description" rows="4" placeholder="请详细描述物品特征、颜色、品牌等信息..."></textarea>
                </div>
                <div class="form-group">
                    <label>物品图片</label>
                ...
                <button type="submit" class="btn btn-danger btn-lg btn-block">提交发布</button>
            </form>
        </div>
    </div>
</div>
...
<script>
    ...
    $(function(){
        $('#publishLostForm').on('submit', function(e){
            e.preventDefault();
            var formData = new FormData(this);
            formData.append('action', 'publish');
            $.ajax({
                url: contextPath + '/LostItemServlet',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(res){
                    if (res.code === 1) {
                        showToast('发布成功！');
                        setTimeout(function(){ window.location.href = contextPath + '/lost-list.jsp'; }, 1000);
                    } else {
